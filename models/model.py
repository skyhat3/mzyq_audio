...
class PANNS_CNN6(nn.Module):
    ...
    def __init__(self, num_class, input_size, dropout=0.1, extract_embedding: bool = True,in_channels=1):

        super(PANNS_CNN6, self).__init__()
        self.bn0 = nn.BatchNorm2d(input_size)
        self.conv_block1 = ConvBlock5x5(in_channels=in_channels, out_channels=64)
...
if __name__=='__main__':
    a=torch.randn(4,20,442)
    model=PANNS_CNN10(num_class=10,input_size=442)
    print(model(a).shape)